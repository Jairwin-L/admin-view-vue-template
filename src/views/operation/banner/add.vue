  ...
  <div class="container" v-if="model">
    <Row class="form-box">
      <i-col span="24">
        <div class="main-item">
          <p><span>*</span>KEY：</p>
          <Input size="small" v-model="model.key" placeholder="请输入KEY" style="width: 300px;"/>
        </div>
        <div class="main-item">
          <p><span>*</span>平台：</p>
        ...
        <div class="main-item">
          <p><span>*</span>目标值：</p>
          <Input size="small" v-model="model.target" placeholder="请输入目标值" style="width: 300px;"/>
        </div>
        <div class="main-item">
          <p>标题：</p>
          <Input size="small" v-model="model.title" placeholder="请输入标题" style="width: 300px;"/>
        </div>
        <div class="main-item">
          <p>排序：</p>
        ...
        <div class="main-item">
          <p>备注说明：</p>
          <Input size="small" type="textarea" v-model="model.remark" placeholder="请输入备注说明" style="width: 300px;"/>
        </div>
        <up-single-pic @save="submitPic" :images="model.image" :title="'封面:'"></up-single-pic>
        <div class="main-item">
          <Button size="small" type="primary" @click="onSubmit">确认保存</Button>
        </div>
      </i-col>
    </Row>
  </div>
